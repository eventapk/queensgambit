...
try {
final doc = await FirebaseFirestore.instance.collection('users').doc(p.phone).get();
...
Widget _iconBtn(IconData icon, Color color, double screenWidth, VoidCallback onTap) {
